...
const translations = {
  en: {
    ...
    firstRun: "The first run downloads model files (about 500 MB) and takes several minutes.",
  ...
  el: {
    ...
    firstRun: "Στην πρώτη εκτέλεση κατεβαίνουν τα μοντέλα (περίπου 500 MB), γι' αυτό χρειάζεται μερικά λεπτά.",
